      ...
      <nav className="flex justify-between items-center">
        ...
        <div className="flex items-center">
          ...
          <div className={`absolute right-0 mt-2 w-48 bg-black border-b-1 border-grey ${isDropdownOpen ? '' : 'hidden'}`}>
            ...
            {/* <a href={`/profiles/${user_username}`} className="block px-4 py-2 text-grey-200 hover:bg-grey-500 border-b-2 border-grey-200">My Profile</a> */}
            <a href={`/profiles/${user_username}`} className="block px-4 py-2 text-grey-200 hover:bg-grey-500 border-b-2 border-grey-200">My Profile</a>
            {/* hardcoded for now */}
            {/* <a href="/profiles/stephanie" className="block px-4 py-2 text-grey-200 hover:bg-grey-500 border-b-2 border-grey-200">My Profile</a> */}
            <a href="/" className="block px-4 py-2 text-grey-200 hover:bg-grey-500 ">Settings</a>
          </div>
        </div>
